<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="业主账号" prop="yezhuzhanghao">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yezhuzhanghao" label="业主账号" prop="yezhuzhanghao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="仪表编号" prop="yibiaobianhao">
          <el-input v-model="ruleForm.yibiaobianhao" 
              placeholder="仪表编号" clearable  :readonly="ro.yibiaobianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="仪表编号" prop="yibiaobianhao">
              <el-input v-model="ruleForm.yibiaobianhao" 
                placeholder="仪表编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="水表位数" prop="shuibiaoweishu">
          <el-input v-model="ruleForm.shuibiaoweishu" 
              placeholder="水表位数" clearable  :readonly="ro.shuibiaoweishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="水表位数" prop="shuibiaoweishu">
              <el-input v-model="ruleForm.shuibiaoweishu" 
                placeholder="水表位数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用水吨数" prop="yongshuidunshu">
          <el-input v-model="ruleForm.yongshuidunshu" 
              placeholder="用水吨数" clearable  :readonly="ro.yongshuidunshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用水吨数" prop="yongshuidunshu">
              <el-input v-model="ruleForm.yongshuidunshu" 
                placeholder="用水吨数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	loufanghao : false,
	yibiaobianhao : false,
	shuibiaoweishu : false,
	yongshuidunshu : false,
	yuefen : false,
	gonghao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.loufanghao = true;
          ...
          if(o=='yibiaobianhao'){
            this.ruleForm.yibiaobianhao = obj[o];
	    this.ro.yibiaobianhao = true;
            continue;
          }
          if(o=='shuibiaoweishu'){
            this.ruleForm.shuibiaoweishu = obj[o];
	    this.ro.shuibiaoweishu = true;
            continue;
          }
          if(o=='yongshuidunshu'){
            this.ruleForm.yongshuidunshu = obj[o];
	    this.ro.yongshuidunshu = true;
            continue;
          }
          if(o=='yuefen'){
    ...
    yezhuzhanghaoChange () {
      this.$http({
        url: `follow/yezhu/yezhuzhanghao?columnValue=`+ this.ruleForm.yezhuzhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shuibiaoshuju/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shuibiaoshujuCrossAddOrUpdateFlag = false;
                  this.parent.search();
