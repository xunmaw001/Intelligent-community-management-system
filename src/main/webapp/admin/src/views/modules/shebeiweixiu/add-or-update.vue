    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="维修原因" prop="weixiuyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="维修原因"
                  v-model="ruleForm.weixiuyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weixiuyuanyin" label="维修原因" prop="weixiuyuanyin">
                    <span>{{ruleForm.weixiuyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weixiuxiangmu = true;
          ...
          if(o=='weixiuyuanyin'){
            this.ruleForm.weixiuyuanyin = obj[o];
	    this.ro.weixiuyuanyin = true;
            continue;
          }
          if(o=='weixiujieguo'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shebeiweixiu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeiweixiuCrossAddOrUpdateFlag = false;
                  this.parent.search();
