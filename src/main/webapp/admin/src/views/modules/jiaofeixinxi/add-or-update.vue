    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="缴费单号" prop="jiaofeidanhao">
            <el-input v-model="ruleForm.jiaofeidanhao" 
                placeholder="缴费单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiaofeidanhao" label="缴费单号" prop="jiaofeidanhao">
              <el-input v-model="ruleForm.jiaofeidanhao" 
                placeholder="缴费单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开单日期" prop="kaidanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kaidanriqi" 
                type="date"
                placeholder="开单日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaidanriqi" label="开单日期" prop="kaidanriqi">
              <el-input v-model="ruleForm.kaidanriqi" 
                placeholder="开单日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaofeijine = true;
          ...
          if(o=='kaidanriqi'){
            this.ruleForm.kaidanriqi = obj[o];
	    this.ro.kaidanriqi = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.jiaofeileixingOptions = "物业费,水费,电费,燃气费,维修费,其他".split(',')
    },
    // 下二随
    yezhuzhanghaoChange () {
      this.$http({
