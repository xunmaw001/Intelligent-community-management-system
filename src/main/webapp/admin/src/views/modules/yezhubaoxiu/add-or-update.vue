<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报修项目" prop="baoxiuxiangmu">
          <el-input v-model="ruleForm.baoxiuxiangmu" 
              placeholder="报修项目" clearable  :readonly="ro.baoxiuxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报修项目" prop="baoxiuxiangmu">
              <el-input v-model="ruleForm.baoxiuxiangmu" 
                placeholder="报修项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.loufanghao = true;
          ...
          if(o=='baoxiuxiangmu'){
            this.ruleForm.baoxiuxiangmu = obj[o];
	    this.ro.baoxiuxiangmu = true;
            continue;
          }
          if(o=='baoxiuneirong'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yezhubaoxiu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yezhubaoxiuCrossAddOrUpdateFlag = false;
                  this.parent.search();
