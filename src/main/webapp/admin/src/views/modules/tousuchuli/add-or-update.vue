    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="处理内容" prop="chulineirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chulineirong" label="处理内容" prop="chulineirong">
                    <span>{{ruleForm.chulineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
