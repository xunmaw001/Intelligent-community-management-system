<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="设备位置" prop="shebeiweizhi">
          <el-input v-model="ruleForm.shebeiweizhi" 
              placeholder="设备位置" clearable  :readonly="ro.shebeiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="设备位置" prop="shebeiweizhi">
              <el-input v-model="ruleForm.shebeiweizhi" 
                placeholder="设备位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="设备类型" prop="shebeileixing">
          <el-select v-model="ruleForm.shebeileixing" placeholder="请选择设备类型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="安装日期" prop="anzhuangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.anzhuangriqi" 
                type="date"
                placeholder="安装日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.anzhuangriqi" label="安装日期" prop="anzhuangriqi">
              <el-input v-model="ruleForm.anzhuangriqi" 
                placeholder="安装日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="设备介绍" prop="shebeijieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="设备介绍"
                  v-model="ruleForm.shebeijieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shebeijieshao" label="设备介绍" prop="shebeijieshao">
                    <span>{{ruleForm.shebeijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeileixing = true;
          ...
          if(o=='shebeijieshao'){
            this.ruleForm.shebeijieshao = obj[o];
	    this.ro.shebeijieshao = true;
            continue;
          }
          if(o=='shebeishuliang'){
	    ...
	    this.ro.goumaijiage = true;
          ...
          if(o=='anzhuangriqi'){
            this.ruleForm.anzhuangriqi = obj[o];
	    this.ro.anzhuangriqi = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wuyeshebei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wuyeshebeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
