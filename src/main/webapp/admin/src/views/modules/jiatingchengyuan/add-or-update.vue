<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成员姓名" prop="chengyuanxingming">
          <el-input v-model="ruleForm.chengyuanxingming" 
              placeholder="成员姓名" clearable  :readonly="ro.chengyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成员姓名" prop="chengyuanxingming">
              <el-input v-model="ruleForm.chengyuanxingming" 
                placeholder="成员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiatingchengyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiatingchengyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
