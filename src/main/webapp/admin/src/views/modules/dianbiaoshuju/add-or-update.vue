<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电表位数" prop="dianbiaoweishu">
          <el-input v-model="ruleForm.dianbiaoweishu" 
              placeholder="电表位数" clearable  :readonly="ro.dianbiaoweishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电表位数" prop="dianbiaoweishu">
              <el-input v-model="ruleForm.dianbiaoweishu" 
                placeholder="电表位数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用电度数" prop="yongdiandushu">
          <el-input v-model="ruleForm.yongdiandushu" 
              placeholder="用电度数" clearable  :readonly="ro.yongdiandushu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用电度数" prop="yongdiandushu">
              <el-input v-model="ruleForm.yongdiandushu" 
                placeholder="用电度数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yibiaobianhao = true;
          ...
          if(o=='dianbiaoweishu'){
            this.ruleForm.dianbiaoweishu = obj[o];
	    this.ro.dianbiaoweishu = true;
            continue;
          }
          if(o=='yongdiandushu'){
            this.ruleForm.yongdiandushu = obj[o];
	    this.ro.yongdiandushu = true;
            continue;
          }
          if(o=='yuefen'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `dianbiaoshuju/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dianbiaoshujuCrossAddOrUpdateFlag = false;
                  this.parent.search();
