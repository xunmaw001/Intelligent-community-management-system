<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位价格" prop="cheweijiage">
          <el-input v-model="ruleForm.cheweijiage" 
              placeholder="车位价格" clearable  :readonly="ro.cheweijiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车位价格" prop="cheweijiage">
              <el-input v-model="ruleForm.cheweijiage" 
                placeholder="车位价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="使用期限" prop="shiyongqixian">
          <el-input v-model="ruleForm.shiyongqixian" 
              placeholder="使用期限" clearable  :readonly="ro.shiyongqixian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="使用期限" prop="shiyongqixian">
              <el-input v-model="ruleForm.shiyongqixian" 
                placeholder="使用期限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weizhi = true;
          ...
          if(o=='cheweijiage'){
            this.ruleForm.cheweijiage = obj[o];
	    this.ro.cheweijiage = true;
            continue;
          }
          if(o=='kaishishijian'){
	    ...
	    this.ro.kaishishijian = true;
          ...
          if(o=='shiyongqixian'){
            this.ruleForm.shiyongqixian = obj[o];
	    this.ro.shiyongqixian = true;
            continue;
          }
          if(o=='jieshushijian'){
